...
import { X, Clock, MessageSquare, Mic, Send, Heart, ArrowLeft } from 'lucide-react';
        ...
        <div className="flex flex-wrap gap-2 justify-center">
          {quickReplies.map((reply, index) => (
            <button
              ...
              className="px-2 sm:px-3 py-1.5 sm:py-2 text-xs sm:text-sm rounded-full border bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 border-gray-200 dark:border-gray-600 hover:bg-purple-50 dark:hover:bg-purple-900/20 hover:border-purple-300 dark:hover:border-purple-600 transition-all duration-200"
            >
              {reply}
            </button>
          ))}
        ...
        <div className="flex items-end space-x-2 sm:space-x-3">
          <div className="flex-1">
            <textarea
              ...
              className="w-full px-3 sm:px-4 py-2.5 sm:py-3 rounded-2xl border resize-none transition-all duration-200 text-sm sm:text-base bg-white dark:bg-gray-800 text-gray-900 dark:text-white border-gray-200 dark:border-gray-600 focus:border-purple-500 dark:focus:border-purple-400 focus:ring-2 focus:ring-purple-500/20"
              rows={1}
