    ...
    <section className="py-20 bg-[#f8f5ff]">
      <div className="container mx-auto px-6">
        <div className="max-w-3xl mx-auto text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-[#2d3748] mb-4">Real Moments, Real Healing</h2>
          <p className="text-lg text-[#4a5568]">What our users say about their journey with Amara.</p>
        </div>
          ...
          <div className="relative">
            <div className="absolute inset-0 flex items-center justify-between z-10 pointer-events-none">
              <button 
                ...
                className="w-10 h-10 rounded-full bg-white shadow-md flex items-center justify-center text-[#6b5ca5] hover:text-[#9d8cd4] transition-colors duration-300 pointer-events-auto"
              >
                ...
                {testimonials.map((testimonial, index) => (
                  <div key={index} className="w-full flex-shrink-0 px-4">
                    <div className="bg-white rounded-2xl shadow-lg p-8 md:p-10">
                      ...
                      <p className="text-xl text-[#2d3748] mb-8 italic">{testimonial.quote}</p>
                      <div className="flex items-center">
                        <div className="w-12 h-12 bg-[#9d8cd4]/10 rounded-full flex items-center justify-center text-[#9d8cd4]">
