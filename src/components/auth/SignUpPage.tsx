  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-purple-50/30 to-pink-50/30 dark:from-gray-900 dark:via-purple-900/10 dark:to-pink-900/10 flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-purple-200/20 dark:bg-purple-600/10 rounded-full animate-pulse blur-xl"></div>
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-pink-200/20 dark:bg-pink-600/10 rounded-full animate-pulse blur-xl" style={{ animationDelay: '1s' }}></div>
      </div>

      <div className="relative w-full max-w-md">
        {/* Floating Icons - Responsive positioning */}
        <div className="absolute inset-0 pointer-events-none">
          <CheckCircle className="absolute top-32 left-4 sm:left-12 w-4 h-4 sm:w-6 sm:h-6 text-purple-400 transform transition-all duration-1000 opacity-60 animate-bounce" style={{ animationDelay: '0.5s' }} />
          <CheckCircle className="absolute top-48 right-8 sm:right-20 w-5 h-5 sm:w-7 sm:h-7 text-pink-400 transform transition-all duration-1000 opacity-60 animate-pulse" style={{ animationDelay: '1s' }} />
        </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-4 py-3 border rounded-xl focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 dark:focus:border-purple-400 transition-colors duration-200 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 ${
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-12 py-3 border rounded-xl focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 dark:focus:border-purple-400 transition-colors duration-200 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 ${
