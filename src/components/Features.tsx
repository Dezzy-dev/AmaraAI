    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-6">
        <div className="max-w-3xl mx-auto text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-[#2d3748] mb-4">What Amara Helps With</h2>
          <p className="text-lg text-[#4a5568]">Your companion for life's emotional challenges, big and small.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div 
              key={index} 
              className="bg-[#f8f5ff] hover:bg-white p-8 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300 group"
            >
              <div className="w-12 h-12 bg-[#9d8cd4]/10 rounded-xl flex items-center justify-center mb-6 text-[#9d8cd4] group-hover:bg-[#9d8cd4] group-hover:text-white transition-all duration-300">
                {feature.icon}
              </div>
