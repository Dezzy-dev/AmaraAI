  ...
  const comparisonData = [
    {
      ...
      amaraIcon: <DollarSign className="w-5 h-5" />,
      traditionalIcon: <DollarSign className="w-5 h-5" />,
    ...
    },
    {
      ...
      amaraIcon: <Clock className="w-5 h-5" />,
      traditionalIcon: <Calendar className="w-5 h-5" />,
      amaraColor: "text-green-600",
    ...
    },
    {
      ...
      amaraIcon: <MapPin className="w-5 h-5" />,
      traditionalIcon: <MapPin className="w-5 h-5" />,
      amaraColor: "text-green-600",
      traditionalColor: "text-orange-600"
    },
    {
      ...
      amaraIcon: <Shield className="w-5 h-5" />,
      traditionalIcon: <Shield className="w-5 h-5" />,
      amaraColor: "text-green-600",
    ...
    },
    {
      ...
      amaraIcon: <Brain className="w-5 h-5" />,
      traditionalIcon: <MessageCircle className="w-5 h-5" />,
      amaraColor: "text-green-600",
      ...
      <div className="relative">
        ...
        <div className="max-w-6xl mx-auto px-4 py-12">
          ...
          <div className={`text-center mb-16 transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-100 to-pink-100 dark:from-purple-900/30 dark:to-pink-900/30 rounded-full border border-purple-200 dark:border-purple-700 mb-6">
          ...
          {/* Comparison Section */}
          <div className={`mb-20 transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`} style={{ transitionDelay: '0.2s' }}>
          ...
          <div className={`transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`} style={{ transitionDelay: '0.4s' }}>
            ...
            <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
              ...
              >
                ...
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                  <div className="bg-gradient-to-r from-purple-600 to-pink-600 text-white text-sm font-bold px-4 py-2 rounded-full flex items-center">
                ...
                <div className="p-8">
                  <div className="text-center mb-6">
                    ...
                    <div className="flex items-center justify-center space-x-2 mb-2">
                      <span className="text-4xl font-bold text-gray-900 dark:text-white">${yearlyPrice}</span>
                      <span className="text-gray-500 dark:text-gray-400">/year</span>
                    </div>
                    <p className="text-purple-600 dark:text-purple-400 font-medium">
                      Equals ${yearlyMonthlyEquivalent.toFixed(2)}/month
                    </p>
                    <div className="inline-flex items-center px-3 py-1 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 rounded-full text-sm font-medium mt-2">
            ...
            <div className="text-center mt-12">
              <button
                ...
                className="group relative inline-flex items-center px-12 py-6 bg-gradient-to-r from-purple-600 to-pink-600 text-white text-xl font-bold rounded-full shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:scale-105 overflow-hidden"
              >
                {/* Animated background */}
                ...
                <span className="relative flex items-center">
                  <Heart className="w-6 h-6 mr-3 animate-pulse" fill="currentColor" />
